...
class Jetpack_Recipes {
	...
	function add_scripts() {
		...
		wp_enqueue_script(
			...
			plugins_url( '_inc/build/shortcodes/js/recipes-printthis.min.js', JETPACK__PLUGIN_FILE ),
			array( 'jquery' ),
			'20170202'
		);
		...
		wp_enqueue_script(
			'jetpack-recipes-js',
			plugins_url( '_inc/build/shortcodes/js/recipes.min.js', JETPACK__PLUGIN_FILE ),
